"""
Jasper Earthy Theme
Rich earth tones from Oregon's Willow Creek region
"""
...
ELEMENT_STYLES = {
    ...
    "Hr": {
        "border": "none",
        "height": "2px",
        "background": f"linear-gradient(to right, {COLORS['surface_variant']}, {COLORS['willow_pink']}, {COLORS['accent']}, {COLORS['willow_green']}, {COLORS['surface_variant']})",
        "margin": "1.5em 0",
    },
    "Form": {
        "margin": "1em 0",
    ...
    "Mark": {
        "background-color": COLORS["owyhee_red"],
